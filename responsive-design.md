...
- **Flexbox vs Grid**: Flexbox for 1-dimensional, Grid for 2-dimensional
...
- [ui-component-patterns](https://github.com/supercent-io/skills-template/blob/HEAD/.agent-skills/responsive-design/../ui-component-patterns/SKILL.md): Responsive components

- [web-accessibility](https://github.com/supercent-io/skills-template/blob/HEAD/.agent-skills/responsive-design/../web-accessibility/SKILL.md): Consider alongside accessibility
