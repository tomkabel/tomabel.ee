...
- "Invalid input" ❌ → "Email must be in format: [example@domain.com]("https://github.com/supercent-io/skills-template/blob/HEAD/.agent-skills/web-accessibility/mailto:example@domain.com")" ✅
...
- [ui-component-patterns]("https://github.com/supercent-io/skills-template/blob/HEAD/.agent-skills/web-accessibility/../ui-component-patterns/SKILL.md"): UI component implementation

- [responsive-design]("https://github.com/supercent-io/skills-template/blob/HEAD/.agent-skills/web-accessibility/../responsive-design/SKILL.md"): Responsive design
