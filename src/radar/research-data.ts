...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    abstract: {
      en: "A technical analysis of Google's BotGuard VM — a hostile, obfuscated JavaScript Virtual Machine used for bot detection. Maps opcode architecture, anti-debug defenses, anti-logger mechanisms, and evaluates bypass strategies including the Puppet approach using go-rod.",
