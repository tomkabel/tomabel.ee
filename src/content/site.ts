...
export const disclosures: Disclosure[] = [
  ...
  {
    kind: 'essay',
    title: { en: 'How client-side anti-fraud actually works, and why VLMs break it', et: 'Kuidas kliendipoolne pettusetõrje tegelikult töötab ja miks visuaal-keelemudelid selle murravad' },
    blurb: {
      en: 'Client-side anti-fraud does not measure humanity, it measures the cost of forgery. An AI agent that simply looks at the page and operates it pays no forgery cost at all. What that does to each of the five defensive paradigms, and why the open question is now who controls the root of trust.',
      et: 'Kliendipoolne pettusetõrje ei mõõda inimlikkust, vaid võltsimise hinda. Tehisintellekti agent, kes lihtsalt vaatab lehte ja kasutab seda, ei maksa võltsimise eest midagi. Mida see teeb viie kaitseparadigmaga ja miks on lahtine küsimus nüüd see, kes kontrollib usalduse juurt.',
    },
    ...
    meta: { en: 'Published · 8 min read', et: 'Avaldatud · 8 min lugemist' },
  ...
  },
  {
    ...
    meta: { en: 'Published · 9 min read', et: 'Avaldatud · 9 min lugemist' },
  ...
  },
  {
    ...
    type: { en: 'Framework Analysis', et: 'Raamistiku analüüs' },
    meta: { en: 'Published · 6 min read', et: 'Avaldatud · 6 min lugemist' },
  ...
  },
  {
    ...
    blurb: {
      en: 'The full end-to-end trace of Archetype C breach: dependency, pipeline, credential, production. Why the CI/CD pipeline is the highest-value target in a velocity-optimised architecture, and which fixes a startup will actually keep.',
      et: 'Arhetüüp C rünnaku täielik jälg: sõltuvus, konveier, mandaat, toodang. Miks on CI/CD-konveier kiirusele optimeeritud arhitektuuris kõrgeima väärtusega sihtmärk ja millised parandused idufirmas päriselt püsima jäävad.',
    },
    tags: ['Zero Trust', 'Supply Chain', 'CI/CD', 'Kubernetes'],
    keywords: 'supply chain attack, CI/CD security, trust on first use, typosquatting, GitOps, workload identity, SPIFFE, container image signing, eBPF runtime detection, zero trust architecture',
    type: { en: 'Framework Analysis', et: 'Raamistiku analüüs' },
    meta: { en: 'Published · 8 min read', et: 'Avaldatud · 8 min lugemist' },
  ...
  },
  {
    ...
    meta: { en: 'Published · 7 min read', et: 'Avaldatud · 7 min lugemist' },
