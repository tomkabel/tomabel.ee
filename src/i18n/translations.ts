    ...
    legal: {
      ...
      terms: {
        ...
        intellectual: {
          ...
          text2: 'Don\'t steal our content. If you want to use our research or reference our tools, just ask us first.',
          text3: 'The name ProksiAbel is ours.',
        },
        userObligations: {
          title: 'Don\'t Be Stupid',
          text: 'While you are here, do not:',
          items: [
            'Lie on the contact form.',
            'Try to hack the website. (We test systems for a living; poking our public landing page is boring).',
  ...
  et: {
    ...
    legal: {
      ...
      terms: {
        ...
        intellectual: {
          title: 'Kes mida omab',
          text: 'Tekst, logod ja selle saidi kood kuuluvad meile. Need on kaitstud tavaliste autoriõiguse seadustega.',
          text2: 'Ära varasta meie sisu. Kui tahad meie uuringuid kasutada või tööriistadele viidata, lihtsalt küsi enne.',
          text3: 'Nimi ProksiAbel on meie oma.',
        },
        userObligations: {
          title: 'Ära tee lollusi',
          text: 'Kui sa siin oled, siis palun ära:',
          items: [
            'Valeta kontaktivormis.',
            'Ürita seda veebisaiti häkkida. (Me testime süsteeme elatise teenimiseks; meie avaliku maandumislehe torkimine on igav).',
            'Käivita automatiseeritud skreipereid, mis eiravad meie robots.txt faili.',
            'Tee midagi ebaseaduslikku.',
          ],
        },
        Disclaimer: {
          title: 'Lahtiütlus',
        ...
        limitation: {
          title: 'Vastutus (või selle puudumine)',
          text: 'Niikaugele kui seadus lubab, ei vastuta ProksiAbel OÜ, kui su äri kaotab raha, andmeid või mainet sellepärast, et sa seda veebilehte kasutasid.',
          items: [
            'Kui meie leht läheb offline, on see meie viga, aga me ei võlgne sulle midagi.',
            'Kui sa saad kolmanda osapoole lingilt viiruse, pole see meie vastutus.',
          ],
          text2: 'See kehtib sõltumata sellest, kui vihaseks su advokaadid lähevad.',
        },
        indemnification: {
