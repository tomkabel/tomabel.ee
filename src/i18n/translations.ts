export const translations = {
  en: {
    ...
    hero: {
      ...
      securityConsultancy: 'Security Consultancy',
      badgeIntersection: 'Offensive Security • AI/ML • Systems',
      headingLine1: 'The intersection of',
      headingLine2: 'offense & engineering',
      descriptionIntersection: "ProksiAbel OÜ runs specialized security assessments, builds AI infrastructure, and engineers systems at the intersection of all three. The Venn diagram below is the map — click around.",
      ctaIntersection: 'Explore the intersection',
    },
    intersection: {
      vennTitle: 'The Intersection',
      vennDesc: 'Offensive security, AI/ML engineering, and systems architecture — and what happens at their intersections.',
      densityCore: 'Core Thesis',
      densityDense: 'Core Cluster',
      densitySparse: 'Foundation',
      selectedWork: 'Selected Work',
      projectsEmpty: 'Projects pending',
      projectsEmptyDesc: 'This zone will be populated as work evolves.',
      mobileSelect: 'Select a domain intersection:',
    },
    capabilities: {
      title: 'Three Ways of Working',
      desc: 'Capabilities across the intersection — not a menu, but a practice.',
    },
    engagement: {
      title: 'Engagement Models',
      desc: 'Every engagement is different. These are the shapes it usually takes.',
    },
    research: {
    ...
    services: {
      ...
      service1: {
        ...
        heroDescription: 'Seeing your infrastructure exactly how an attacker sees it.',
      },
      service2: {
        ...
        features: [
          ...
          'TLS Client Fingerprinting Defenses',
        ],
        heroDescription: 'Practical engineering solutions that actually hold up under fire.',
      },
      service3: {
        ...
        features: [
          ...
          'JavaScript Bot & Fraud System Reverse Engineering',
        ],
  ...
  et: {
    ...
    hero: {
      ...
      coreServices: 'Põhiteenused',
      exploreServices: 'Vaata teenuseid',
      securityConsultancy: 'Turvanõustamine',
      badgeIntersection: 'Ründeturve • AI/ML • Süsteemid',
      headingLine1: 'Kus ründetugevus',
      headingLine2: 'ja inseneritarkus kohtuvad',
      descriptionIntersection: 'ProksiAbel OÜ teeb spetsialiseeritud turvahindamisi, ehitab AI taristut ja projekteerib süsteeme kõigi kolme valdkonna ristumiskohas. Allolev Venni diagramm on kaart — klikka ringi.',
      ctaIntersection: 'Avasta ristumispunkt',
    },
    intersection: {
      vennTitle: 'Ristumispunkt',
      vennDesc: 'Ründeturve, AI/ML inseneritöö ja süsteemiarhitektuur — ja mis juhtub nende ristumiskohtades.',
      densityCore: 'Põhitees',
      densityDense: 'Põhiklaster',
      densitySparse: 'Alus',
      selectedWork: 'Valitud tööd',
      projectsEmpty: 'Projektid ootel',
      projectsEmptyDesc: 'See ala täidetakse töö edenedes.',
      mobileSelect: 'Vali valdkondade ristumispunkt:',
    },
    capabilities: {
      title: 'Kolm tööviisi',
      desc: 'Võimekus kogu ristumispunkti ulatuses — mitte menüü, vaid praktika.',
    },
    engagement: {
      title: 'Koostöömudelid',
      desc: 'Iga koostöö on erinev. Need on kujundid, mida see tavaliselt võtab.',
    },
    research: {
    ...
    expertise: {
      ...
      projects: 'Projekti',
      certifiedExpert: 'Sertifitseeritud ekspert',
      ...
      offensive: {
        ...
        description: 'Laialt levinud kliendipoolsete bot-tuvastusmehhanismide bypasside loomine.',
      },
      defensive: {
    ...
    contact: {
      title: 'Võta ühendust',
      description: 'Oled valmis teada saama, mis su võrgus tegelikult katki on? Kirjuta meile.',
      email: 'Saada e-kiri',
      call: 'Helista meile',
      address: 'Aadress',
      responseTime: 'Vastus 24 tunni jooksul',
      secureConfidential: 'Turvaline ja konfidentsiaalne',
      form: {
        title: 'Saada sõnum',
        name: 'Nimi',
