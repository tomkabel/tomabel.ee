  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-8">{t.legal.privacyTitle}</h1>

        <div className="max-w-none text-muted">
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.intro.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.controller.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.dataCollected.title}</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-lg text-accent font-medium mb-2">{t.legal.privacy.dataCollected.automatic.title}</h3>
              ...
              <div>
                <h3 className="text-lg text-accent font-medium mb-2">{t.legal.privacy.dataCollected.provided.title}</h3>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.legalBasis.title}</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg text-accent font-medium mb-2">{t.legal.privacy.legalBasis.consent.title}</h3>
                <p className="text-muted leading-relaxed">{t.legal.privacy.legalBasis.consent.text}</p>
              </div>
              <div>
                <h3 className="text-lg text-accent font-medium mb-2">{t.legal.privacy.legalBasis.legitimate.title}</h3>
                <p className="text-muted leading-relaxed">{t.legal.privacy.legalBasis.legitimate.text}</p>
              </div>
              <div>
                <h3 className="text-lg text-accent font-medium mb-2">{t.legal.privacy.legalBasis.legal.title}</h3>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.dataUsage.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.dataSharing.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.retention.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.security.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.yourRights.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.cookies.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.changes.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-accent font-semibold mb-4">{t.legal.privacy.contact.title}</h2>
