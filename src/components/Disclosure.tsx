      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-none text-muted">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted space-y-3">
              ...
              <li>
                ...
                <br />
                <code className="text-sm bg-surface px-2 py-1 rounded mt-1 inline-block">
                  Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 [Security Researcher: Tom Kristian Abel; +https://tomabel.ee/disclosure]
                </code>
              </li>
              <li>
                <strong>{t.disclosure.guidelines.customHeaders}:</strong> {t.disclosure.guidelines.customHeadersDesc}
                <br />
                <code className="text-sm bg-surface px-2 py-1 rounded mt-1 inline-block">X-Security-Scanner: tomabel-SecurityResearch-2026</code>
                <br />
                <code className="text-sm bg-surface px-2 py-1 rounded mt-1 inline-block">X-Contact: security@tomabel.ee</code>
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="text-muted space-y-1">
              <li><strong>{t.disclosure.contact.email}:</strong> <a href="mailto:security@tomabel.ee" className="text-accent hover:underline">{t.disclosure.contact.emailLabel}</a></li>
          ...
          <section className="mb-8">
            ...
            <div className="bg-surface p-4 border border-border text-muted space-y-1">
              ...
              <p><strong className="text-accent">{t.disclosure.company.address}:</strong> Pargi tn 2 Sindi, Tori vald, Pärnumaa 86705, Estonia</p>
              <p><strong className="text-accent">{t.disclosure.company.contact}:</strong> Tom Kristian Abel</p>
            </div>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-subtle text-sm">
            {t.disclosure.generalInquiries}: <a href="mailto:info@proksiabel.ee" className="text-accent hover:underline">info@proksiabel.ee</a>
          </p>
        </div>
      </div>
    </div>
