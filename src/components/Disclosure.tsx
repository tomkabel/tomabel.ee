  ...
  return (
    <div className="min-h-screen bg-slate-900 pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-cyan-500 font-semibold mb-8">{t.disclosure.subtitle}</p>
        ...
        <div className="prose prose-invert prose-cyan max-w-none">
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.purpose.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.whyExists.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.guidelines.title}</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.ifAccessed.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.contact.title}</h2>
            <p className="text-gray-300 leading-relaxed mb-2">
              {t.disclosure.contact.text}
            </p>
            <ul className="text-gray-300 space-y-1">
              <li><strong>{t.disclosure.contact.email}:</strong> <a href="mailto:security@proksiabel.ee" className="text-cyan-400 hover:underline">{t.disclosure.contact.emailLabel}</a></li>
              <li><strong>{t.disclosure.contact.phone}:</strong> +372 56666981</li>
            </ul>
          </section>

          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.company.title}</h2>
            <div className="bg-slate-800 p-4 border border-slate-700 text-gray-300 space-y-1">
              <p><strong className="text-cyan-400">{t.disclosure.company.businessName}:</strong> ProksiAbel OÜ</p>
              <p><strong className="text-cyan-400">{t.disclosure.company.registrationCode}:</strong> 17017826</p>
              <p><strong className="text-cyan-400">{t.disclosure.company.address}:</strong> Pargi tn 2 Sindi, Tori vald, Pärnumaa 86705, Estonia</p>
              <p><strong className="text-cyan-400">{t.disclosure.company.contact}:</strong> Tom Kristian Abel</p>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.pgp.title}</h2>
            <div className="bg-slate-800 p-4 border border-slate-700 text-gray-300 space-y-2">
              <p>
                <a href="/public-key.asc" className="text-cyan-400 hover:underline">{t.disclosure.pgp.download}</a>
              </p>
              <p><strong className="text-cyan-400">{t.disclosure.pgp.keyId}:</strong> 0x30A8306F110AAAC5</p>
              <p><strong className="text-cyan-400">{t.disclosure.pgp.fingerprint}:</strong> 03D8E5A59306ECB7025A21090CA0C6F110AAAC5</p>
              <p><strong className="text-cyan-400">{t.disclosure.pgp.sha256}:</strong> a63667ca9b1729e02b24c19cf2441953b76b934417a17b042fd1eeab68d8530a</p>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.disclosure.acknowledgments.title}</h2>
            <p className="text-gray-300 leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <p className="text-gray-500 text-sm">
            {t.disclosure.generalInquiries}: <a href="mailto:info@proksiabel.ee" className="text-cyan-400 hover:underline">info@proksiabel.ee</a>
          </p>
        </div>
      </div>
    </div>
