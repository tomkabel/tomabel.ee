...
const META: Record<string, Meta> = {
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: "I used to break authentication. Here's what that taught me about building it.", item: 'https://tomabel.ee/disclosures/i-used-to-break-authentication/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'What client-side trust is actually worth', item: 'https://tomabel.ee/disclosures/what-client-side-trust-is-actually-worth/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The kratt problem', item: 'https://tomabel.ee/disclosures/the-kratt-problem/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'Coordinated disclosure in a small country', item: 'https://tomabel.ee/disclosures/coordinated-disclosure-in-a-small-country/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: "The fix that doesn't need SK", item: 'https://tomabel.ee/disclosures/the-fix-that-doesnt-need-sk/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: "The Achilles' heel of Estonia's e-state — Smart-ID / eID research", item: 'https://tomabel.ee/disclosures/smart-id-achilles-heel/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'Zero-Trust Octagon — a framework from first principles', item: 'https://tomabel.ee/disclosures/zero-trust-octagon/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'PACT and the software-anchor turn — a critical analysis of Private Access Control Tokens', item: 'https://tomabel.ee/disclosures/pact-software-anchor-turn/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'ChatGPT is not a phishing scanner', item: 'https://tomabel.ee/disclosures/chatgpt-is-not-a-phishing-scanner/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The PIN that cannot be delegated — Smart-ID, AI agents, and eIDAS', item: 'https://tomabel.ee/disclosures/the-pin-that-cannot-be-delegated/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The evolution of cyber fraud in Estonia, 2010–2026', item: 'https://tomabel.ee/disclosures/the-evolution-of-cyber-fraud-in-estonia/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The Gray Space: Russian Cyber Operations and Estonian Hosting Infrastructure', item: 'https://tomabel.ee/disclosures/russian-cyber-ops-estonia-hosting/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'How client-side anti-fraud actually works, and why VLMs break it', item: 'https://tomabel.ee/disclosures/why-vlms-break-client-side-anti-fraud/' },
          ],
        },
      ],
    },
  ...
  '/disclosures/nine-dimensions-of-zero-trust': {
    title: 'The Nine Dimensions of Zero Trust — Tom Kristian Abel',
    description:
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The Nine Dimensions of Zero Trust', item: 'https://tomabel.ee/disclosures/nine-dimensions-of-zero-trust/' },
          ],
        },
      ],
    },
  ...
  '/disclosures/the-fortune-500-illusion-of-control': {
    title: 'The Fortune 500 Illusion of Control — Tom Kristian Abel',
    description:
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'The Fortune 500 Illusion of Control', item: 'https://tomabel.ee/disclosures/the-fortune-500-illusion-of-control/' },
          ],
        },
      ],
    },
  ...
  '/disclosures/move-fast-fix-it-in-prod': {
    title: 'Move Fast, Fix It In Prod — Tom Kristian Abel',
    description:
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'Move Fast, Fix It In Prod: A Full Breach Trace of the Startup Archetype', item: 'https://tomabel.ee/disclosures/move-fast-fix-it-in-prod/' },
          ],
        },
      ],
    },
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'SaaS-Glued Lean Defense: The Full Breach Trace for Archetype D', item: 'https://tomabel.ee/disclosures/saas-glued-lean-defense/' },
          ],
        },
      ],
    },
  ...
  '/disclosures/identity-is-the-root-proof-is-the-gate': {
    title: 'Identity Is the Root. Proof Is the Gate. — Tom Kristian Abel',
    description:
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://tomabel.ee/' },
            { '@type': 'ListItem', position: 2, name: 'Disclosures', item: 'https://tomabel.ee/disclosures/' },
            { '@type': 'ListItem', position: 3, name: 'Identity Is the Root. Proof Is the Gate.', item: 'https://tomabel.ee/disclosures/identity-is-the-root-proof-is-the-gate/' },
          ],
        },
      ],
    },
