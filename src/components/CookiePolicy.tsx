      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert prose-cyan max-w-none">
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.intro.title}</h2>
            <p className="text-gray-300 leading-relaxed">
              {t.legal.cookies.intro.text}
            </p>
            <p className="text-gray-300 leading-relaxed mt-4 bg-slate-800 p-4 rounded-lg border-l-4 border-cyan-500">
              {t.legal.cookies.intro.text2}
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.whatAre.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.ourApproach.title}</h2>
            <p className="text-gray-300 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              <div className="bg-slate-800 p-4 rounded-lg">
                ...
                <span className="text-gray-300 ml-2">{t.legal.cookies.ourApproach.noCookies}</span>
              </div>
              <div className="bg-slate-800 p-4 rounded-lg">
                <span className="text-green-400 font-semibold">✓</span>
                <span className="text-gray-300 ml-2">{t.legal.cookies.ourApproach.noTracking}</span>
              </div>
              <div className="bg-slate-800 p-4 rounded-lg">
                <span className="text-green-400 font-semibold">✓</span>
                <span className="text-gray-300 ml-2">{t.legal.cookies.ourApproach.noProfiling}</span>
              </div>
              <div className="bg-slate-800 p-4 rounded-lg">
                <span className="text-green-400 font-semibold">✓</span>
                <span className="text-gray-300 ml-2">{t.legal.cookies.ourApproach.noThirdParty}</span>
              </div>
              <div className="bg-slate-800 p-4 rounded-lg md:col-span-2">
                <span className="text-green-400 font-semibold">✓</span>
                <span className="text-gray-300 ml-2">{t.legal.cookies.ourApproach.securityOnly}</span>
              </div>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.cookiesUsed.title}</h2>
            <p className="text-gray-300 leading-relaxed">
              {t.legal.cookies.cookiesUsed.text}
            </p>
            <div className="bg-slate-800 p-6 rounded-lg mt-4">
              <h3 className="text-lg text-cyan-400 font-semibold mb-3">{t.legal.cookies.cookiesUsed.cloudflare.name}</h3>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.analytics.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.consent.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.browserSettings.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.updates.title}</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-cyan-500 font-semibold mb-4">{t.legal.cookies.contact.title}</h2>
            <p className="text-gray-300 leading-relaxed">
