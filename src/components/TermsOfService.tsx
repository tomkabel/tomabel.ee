      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-none text-slate-300">
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.intro.title}</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.services.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.intellectual.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.userObligations.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.Disclaimer.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.thirdParty.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.limitation.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.indemnification.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.governingLaw.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.termination.title}</h2>
            <p className="text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl text-sky-500 font-semibold mb-4">{t.legal.terms.contact.title}</h2>
            <p className="text-slate-300 leading-relaxed">
