...
const sections: EssaySection[] = [
  ...
  {
    heading: {
      en: 'Documented operations',
      et: 'Dokumenteeritud operatsioonid',
    },
    paragraphs: [
      {
  ...
  {
    heading: {
      en: 'The APT attribution question',
      et: 'APT omistamise küsimus',
    },
    paragraphs: [
      {
  ...
  {
    heading: {
      en: 'Defensive implications',
      et: 'Kaitsealased järeldused',
    },
    paragraphs: [
      {
              ...
              <table className="w-full text-sm text-muted">
                <thead>
                  <tr className="border-b border-border">
                    <th scope="col" className="py-2 pr-4 text-left font-semibold text-foreground">{isEn ? 'Source' : 'Allikas'}</th>
                    <th scope="col" className="py-2 text-left font-semibold text-foreground">{isEn ? 'Details' : 'Üksikasjad'}</th>
                  </tr>
                </thead>
                <tbody>
                  {sources.map((s) => (
                    <tr key={s.label} className="border-b border-border/50">
                      <td className="py-2 pr-4 align-top text-foreground">
                        {s.url ? (
                          <a href={s.url} className="text-accent underline decoration-border underline-offset-4 hover:decoration-accent">{s.label}</a>
                        ) : (
                          s.label
                        )}
                      </td>
