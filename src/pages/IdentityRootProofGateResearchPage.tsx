...
const title: Bi = {
  en: 'Identity Is the Root. Proof Is the Gate.',
  et: 'Identiteet on juur. Tõend on värav.',
};
...
const sections: EssaySection[] = [
  ...
  {
    heading: {
      en: 'Network-centric models become identity-centric anyway',
      et: 'Võrgukesksed mudelid muutuvad niikuinii identiteedikeskseteks',
    },
    paragraphs: [
      {
        en: 'The perimeter model worked because the network boundary corresponded to a physical one: being inside the cable plant was evidence that somebody had entered a building and been issued a port. Once the workforce is remote and half the integrations are SaaS-to-SaaS, that correspondence is gone. The boundary survives as a configuration object. It no longer refers to anything.',
        et: 'Perimeetripõhine mudel toimis, sest võrgu piir vastas füüsilisele piirile: kaablivõrgu sees olemine oli tõend, et keegi oli hoonesse sisenenud ja saanud pordi. Kui töötajad on kaugtööl ja pooled liidestused SaaS-ist SaaS-i, on see vastavus kadunud. Piir jääb alles konfiguratsiooniobjektina. See ei viita enam millelegi.',
      },
      {
  ...
  {
    heading: {
      en: 'Authentication events versus continuous proof',
      et: 'Autentimissündmused versus pidev tõend',
    },
    paragraphs: [
      {
        en: 'A login is a point-in-time assertion: at one instant, some set of checks passed. Most architectures treat that instant as a durable fact and build hours or days of implicit authorization on top of it. The session cookie, the refresh token, the cached ticket, the enrolled device — each is a mechanism for not asking again.',
        et: 'Sisselogimine on ajahetke väide: ühel hetkel läbis mingi kontrollide kogum. Enamik arhitektuure kohtleb seda hetke kestva faktina ja ehitab selle peale tunde või päevi kaudset volitamist. Seansiküpsis, värskendusluba, vahemällu salvestatud pilet, registreeritud seade — igaüks neist on mehhanism selleks, et enam mitte küsida.',
      },
      {
        en: 'Continuous proof is the alternative: authorization binds not to a past event but to a context re-evaluated as it changes. Device posture degrades, the scope narrows. Risk signals fire, the session is re-challenged before the next sensitive operation rather than at the next scheduled expiry. The point is not shorter tokens; it is that the authorization decision stops being a memory.',
        et: 'Pidev tõend on alternatiiv: volitus seotakse mitte möödunud sündmuse, vaid kontekstiga, mida muutumise käigus uuesti hinnatakse. Seadme seisund halveneb, ulatus kitseneb. Riskisignaalid vallanduvad, seanssi kontrollitakse enne järgmist tundlikku toimingut, mitte järgmisel plaanipärasel aegumisel. Mõte ei ole lühemad load, vaid see, et volitusotsus lakkab olemast mälestus.',
      },
    ],
  },
  {
    heading: {
      en: 'Six different claims called "authenticated"',
      et: 'Kuus erinevat väidet nimega „autenditud"',
    },
    paragraphs: [
      {
        en: 'The word "authenticated" covers at least six distinct claims that fail in distinct ways. Separating them is the most useful thing an architect can do to an existing design.',
        et: 'Sõna „autenditud" katab vähemalt kuut väidet, mis nurjuvad erineval moel. Nende lahutamine on kõige kasulikum asi, mida arhitekt olemasoleva lahendusega teha saab.',
      },
      {
        en: 'That a secret is present. Somebody supplied a value only the legitimate party should know. This fails to theft, reuse and disclosure, and binds to no person.',
        et: 'Et saladus on olemas. Keegi esitas väärtuse, mida peaks teadma ainult õigustatud osapool. See nurjub varguse, taaskasutuse ja lekke tõttu ega seostu ühegi isikuga.',
      },
      {
        en: 'That a device is present. A key in hardware signed a challenge. Much stronger, and it still proves only that the hardware participated — not who held it, nor whether willingly.',
        et: 'Et seade on olemas. Riistvaras olev võti allkirjastas väljakutse. Palju tugevam, kuid tõendab siiski vaid seda, et riistvara osales — mitte seda, kes seda hoidis ega kas vabatahtlikult.',
      },
      {
        en: 'That a human is present. A liveness or biometric check ran. This defeats automated abuse and does nothing against an accomplice or a coerced user.',
        et: 'Et inimene on kohal. Toimus elusoleku või biomeetriline kontroll. See tõrjub automaatse kuritarvituse ega tee midagi kaasosalise või sunnitud kasutaja vastu.',
      },
      {
        en: 'That the human is the right one. The biometric matched an enrolled template. This is only as good as enrolment, usually the least scrutinised flow in the system.',
  ...
  {
    heading: {
      en: 'Phishing resistance is necessary and not sufficient',
      et: 'Andmepüügikindlus on vajalik, kuid mitte piisav',
    },
    paragraphs: [
      {
  ...
  {
    heading: {
      en: 'What the Estonian eID work shows',
      et: 'Mida Eesti eID-töö näitab',
    },
    paragraphs: [
      {
  ...
  {
    heading: {
      en: 'Proof is the gate',
      et: 'Tõend on värav',
    },
    paragraphs: [
      {
        en: 'Identity-first is often read as "put identity everywhere", which produces a worse system than the one it replaces. Raw identity in every request is a tracking surface and a forgery target. An API gateway does not need to know who you are, only whether this call is allowed.',
      ...
      },
      {
        ...
        et: 'Vahe on sama mis passi ja pardakaardi vahel. Pass ütleb, kes sa oled. Pardakaart ütleb, mida sa tohid järgmisena teha: see lend, see aeg, see värav. Jõustamispunktid peaksid lugema pardakaarte.',
      },
    ],
  },
  {
    heading: {
      en: 'What follows architecturally',
      et: 'Mis sellest arhitektuuriliselt järeldub',
    },
    paragraphs: [
      {
      ...
      },
      {
        ...
        et: 'Käsitlege taastamist ja delegeerimist osana autentimise ründepinnast. Konto taastamine, PIN-koodi lähtestamine, seadme uuesti registreerimine, volikiri ja klienditoe kehastamine toodavad kõik identiteediväite ning on peaaegu alati nõrgemad kui tee, millest nad mööda lähevad. Riistvaraga tagatud peamine tegur, mille taga on kõnekeskuse taastamisprotsess, seab tegeliku kindluse taseme kõnekeskuse tasemele.',
      },
      {
        en: 'Design the approval screen as a security control, because it is one. State the actual operation, counterparty and amount, in the user\'s own language, where the key is used. If the interface cannot express what is being signed, the signature does not mean what the architecture above it assumes.',
...
function IdentityRootProofGateResearchPage() {
          ...
          <section className="mt-16 max-w-measure">
            ...
            <div className="mt-6 space-y-4 text-lg leading-relaxed text-muted">
              <p>
                ...
                {isEn
                  ? '— the nine-dimension framework this argument sits inside, including the identity assurance dimension. The full book is published at '
                  : '— üheksamõõtmeline raamistik, mille sees see argument asub, sealhulgas identiteedikindluse mõõde. Täistekst on avaldatud aadressil '}
              ...
              <p>
                <Link to="/disclosures/smart-id-achilles-heel" className="text-accent underline decoration-border underline-offset-4 hover:decoration-accent">
                  {isEn ? "Smart-ID's Achilles Heel" : 'Smart-ID Achilleuse kand'}
                </Link>{' '}
                {isEn
                  ? '— what the confirmation screen establishes for the user, and what it does not.'
                  : '— mida kinnitusekraan kasutaja jaoks kinnitab ja mida mitte.'}
              </p>
              <p>
...
export default IdentityRootProofGateResearchPage;
