...
const sections: EssaySection[] = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        et: 'See ongi kuues parandus. See ei vaja, et SK muudaks ACSP_V2 sõnumit, ei vaja, et pank muudaks, mida tema rakendus kasutajale näitab, ega vaja, et regulaator midagi kirja paneks. Vaja on, et panga enda taustasüsteem hoiaks parasjagu tehingut tegeva seansi sõrmejälge ja võrdleks seda selle konto kohta juba salvestatud sõrmejälgede ajalooga.',
      },
    ],
  },
  {
  ...
  return (
    <article>
      ...
      <ArticleProof
        ...
        expectedSha256="8353ca3ed1476dc672a2433cf178519b9925e43a42524c42c9dd507553c8c807"
      />
    </article>
  );
}
