...
const sections: EssaySection[] = [
  ...
  {
    heading: { en: 'D1 and D2: trust anchor and identity model', et: 'D1 ja D2: usaldusankur ja identiteedimudel' },
    paragraphs: [
      {
        en: 'D1 answers one question: why should any component of this system believe anything? The positions run from a software CA, through behavioural trust and hybrid hierarchies, to a silicon root of trust, and finally a distributed multi-party root where no single authority can bootstrap trust alone.',
  ...
  {
    heading: { en: 'D3 and D4: the mediation boundary and its evidence', et: 'D3 ja D4: vahendamise piir ja selle tõendid' },
    paragraphs: [
      {
  ...
  },
  {
    ...
    paragraphs: [
      {
        en: 'The matrix is only useful if the position you write down is the one you actually occupy, and the honest answer is usually a step lower than the slide deck. The test for each dimension is an artefact, not an opinion. For D1, name the key and say where it is stored. For D9, call the backup responder at three in the morning.',
  ...
  {
    heading: { en: 'What the matrix does not do', et: 'Mida maatriks ei tee' },
    paragraphs: [
      {
        en: 'The matrix describes configuration. It does not score security. There is no total and no colour-coded grade, and adding one would reintroduce the maturity-ladder thinking it exists to replace. A position high on every dimension is expensive and may be wrong for the threat model; a position low on several may be entirely defensible against a modest adversary.',
...
export default function NineDimensionsZeroTrustPage() {
          ...
          <div className="max-w-measure space-y-6 text-lg leading-relaxed text-muted">
            ...
            <p>
              ...
              {isEn
                ...
                : ', kus on kokku võetud ka neli juurutuse arhetüüpi. See lehekülg on maatriks ise.'}
            </p>
          </div>
          ...
          <section className="mt-16 max-w-measure">
            ...
            <ul className="mt-6 space-y-4 text-lg leading-relaxed text-muted">
              ...
              <li>
                ...
                {isEn
                  ? ' — the full book, including the per-dimension chapters this page condenses.'
